...
function Game(canvas, context) {
  ...
  this.tomato = new Tomato(context, { x: (canvas.width - 300), y: (canvas.height - 500) });
}
...
Game.prototype = {
  start: function() {
    ...
    function onKeyDown(event) {
      ...
      var keys = {
        37: this.face.moveLeft.bind(face),
        38: this.face.moveUp.bind(face),
        39: this.face.moveRight.bind(face),
        40: this.face.moveDown.bind(face)
      };
